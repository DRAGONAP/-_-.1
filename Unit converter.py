...
#Creating the Unit Convertor label
main = tk.Label(window,text = 'Unit Convertor',bg = 'peach puff2',fg = 'blue')
main['font'] = font1
...
art = tk.Label(window,text = 'Aditi Kharate',bg = 'peach puff2',fg = 'blue',anchor = 'center')
art['font'] = font3
